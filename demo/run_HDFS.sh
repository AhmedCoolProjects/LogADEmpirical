...
# MINE: Run LogAnomaly on Linux24 dataset
python main_run.py --data_dir ./dataset/preprocessed/LINUX24APT --output_dir ./output/ --model_name DeepLog --dataset_name LINUX24APT --grouping session --window_size 10 --step_size 1 --train_size 0.01 --is_chronological --session_level entry --log_file LINUX24APT.log --batch_size 2048 --lr 0.001 --accumulation_step 1 --optimizer adamw --sequential --history_size 10 --embeddings embeddings_average.json --hidden_size 128 --num_layers 2 --embedding_dim 300 --topk 10 --dropout 0.1 --max_epoch 10
